...
if __name__ == '__main__':
    ...
    # Define the four points of the rectangle
    points = [
        [320.51, 11.93, -140.42, 0],  # point_a
        [320.51, 11.93, 0, 0],        # point_b
        [299.58, -113.76, 0, 0],      # point_c
        [299.58, -113.76, -140.59, 0] # point_d
    ]

    while True:
        # Move through each point in the rectangle
        for point in points:
